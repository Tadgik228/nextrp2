...
function Window:draw()
	local color = self.focused and tocolor(50, 54, 57, 255) or tocolor(50, 54, 57, 200)

	-- titlebar
	dxDrawRectangle(self.x, self.y, self.w, self.titleh, tocolor(35, 36, 40, 255))
	...
	self:drawBorders(2, tocolor(39, 174, 96, 155))
end
