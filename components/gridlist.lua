...
function Gridlist:draw()
	...
	dxDrawRectangle(self.x, self.y, self.w, self.h, tocolor(50, 54, 57, 50))
...
function Gridlist:drawItems()
	...
	for i=self.sp, self.ep do
		...
		local textColor = (self.selectedItem == i and tocolor(255,255,255)) or (mo and tocolor(255, 255, 255,255)) or item.color or tocolor(255,255,255)
		local bgColor = (self.selectedItem == i and tocolor(39, 174, 96,255)) or (mo and tocolor(39, 174, 96, 255)) or item.bgColor or tocolor(35, 36, 40, 255)
