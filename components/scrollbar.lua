...
function Scrollbar:draw()
	...
	dxDrawRectangle(x, y, w, h, tocolor(35, 36, 40, 255))
end
...
function Thumb:draw()
	...
	if parent then
		...
		local color = (self.dragArea.mouseDown or self.dragArea.mouseOver) and tocolor(39, 174, 96, 255) or tocolor(204, 204, 204, 255)
